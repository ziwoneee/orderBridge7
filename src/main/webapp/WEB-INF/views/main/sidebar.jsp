<%@ page contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
	...
	<nav class="sidebar sidebar-offcanvas" id="sidebar">
	  <ul class="nav">
	          <!-- 기준 정보 관리 시작 -->
	          <li class="nav-item">
	            <a class="nav-link" data-toggle="collapse" href="#menu-basic" aria-expanded="false" aria-controls="menu-basic">
	              <i class="ti-layers-alt menu-icon"></i>
	              <span class="menu-title">기준 정보 관리</span>
	              <i class="menu-arrow"></i>
	            </a>
	            <div class="collapse" id="menu-basic">
	          ...
	          <!-- 영업 관리 시작 -->
	          <li class="nav-item">
	            <a class="nav-link" data-toggle="collapse" href="#menu-sales" aria-expanded="false" aria-controls="menu-sales">
	          ...
	          <!-- 생산 관리 시작 -->
	          <li class="nav-item">
	            <a class="nav-link" data-toggle="collapse" href="#menu-production" aria-expanded="false" aria-controls="menu-production">
	              <i class="ti-reload menu-icon"></i>
	              <span class="menu-title">생산 관리</span>
	              <i class="menu-arrow"></i>
	            </a>
	            <div class="collapse" id="menu-production">
	              <ul class="nav flex-column sub-menu">
	                <li class="nav-item"> <a class="nav-link" href="${pageContext.request.contextPath}/plan/register">계획 등록</a></li>
	                <li class="nav-item"> <a class="nav-link" href="${pageContext.request.contextPath}/plan/list">계획 목록</a></li>
	                <li class="nav-item"> <a class="nav-link" href="${pageContext.request.contextPath}/mps/production/write">작업 지시 목록</a></li>
	                <li class="nav-item"> <a class="nav-link" href="${pageContext.request.contextPath}/mps/quality/list">실적 관리</a></li>
	              </ul>
	            </div>
	          </li>
	          <!-- 생산 관리 끝 -->
	          ...
	          <!-- 자재 관리 시작 -->
	          <li class="nav-item">
	            <a class="nav-link" data-toggle="collapse" href="#menu-material" aria-expanded="false" aria-controls="menu-material">
	              <i class="ti-package menu-icon"></i>
	              <span class="menu-title">자재 관리</span>
	              <i class="menu-arrow"></i>
	            </a>
	            <div class="collapse" id="menu-material">
	              <ul class="nav flex-column sub-menu">
	          ...
	          <!-- 완제품 관리 시작 -->
	          <li class="nav-item">
	            <a class="nav-link" data-toggle="collapse" href="#menu-product" aria-expanded="false" aria-controls="menu-product">
