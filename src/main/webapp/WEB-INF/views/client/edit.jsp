  ...
  <div class="container-fluid page-body-wrapper">
    ...
    <div class="main-panel">
      <div class="content-wrapper">
        ...
        <form action="/client/update" method="post" onsubmit="return validateForm();">
            ...
            <div class="row">
              ...
              <div class="col-md-6 mb-3">
                ...
                <input type="text" id="businessNumber" name="businessNumber" class="form-control"
                       value="${client.businessNumber}" placeholder="예: 123-45-67890"
                       maxlength="12" pattern="^\d{3}-\d{2}-\d{5}$" title="형식: 123-45-67890" readonly />
              </div>
              ...
              <div class="col-md-6 mb-3">
                ...
                <select name="clientType1" class="form-control" required>
                  ...
                  <option value="법인"        ${client.clientType1 == '법인' ? 'selected' : ''}>법인</option>
                  <option value="개인사업자"  ${client.clientType1 == '개인사업자' ? 'selected' : ''}>개인사업자</option>
                  <option value="기타"        ${client.clientType1 == '기타' ? 'selected' : ''}>기타</option>
                </select>
              </div>
              ...
              <div class="col-md-6 mb-3">
                ...
                <select name="clientType2" class="form-control" required>
                  <option value="">선택</option>
                  <option value="도매" ${client.clientType2 == '도매' ? 'selected' : ''}>도매</option>
                  <option value="소매" ${client.clientType2 == '소매' ? 'selected' : ''}>소매</option>
                  <option value="기타" ${client.clientType2 == '기타' ? 'selected' : ''}>기타</option>
                </select>
              </div>
            </div>
          </div>
          ...
          <div class="card-section">
            ...
            <div class="row">
              ...
              <div class="col-md-6 mb-3">
                ...
                <input type="text" id="managerTel" name="managerTel" class="form-control" required
                       placeholder="예: 010-1234-5678"
                       pattern="^01[0-9]-\d{3,4}-\d{4}$" title="형식: 010-1234-5678"
                       value="${client.managerTel}">
              </div>
              <div class="col-md-6 mb-3">
                <label>팩스</label>
          ...
          <div class="text-right mt-4">
            <a href="/client/detail?clientId=${client.clientId}" class="btn btn-outline-secondary">취소</a>
