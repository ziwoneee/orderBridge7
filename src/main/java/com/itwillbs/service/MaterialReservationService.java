...
public interface MaterialReservationService {
     ...
     */
    String registerOrDraftOutbound(String workOrderId, String userId) throws Exception;
     ...
     */
    void releaseReservationOnIssue(String workOrderId, List<Map<String,Object>> items, String userId) throws Exception;
    
    // 등록 직전 "예약만" 선처리: 전표/PO 생성 안 함	
    boolean reserveOnlyForWo(String workOrderId) throws Exception;
